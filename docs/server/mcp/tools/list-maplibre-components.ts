...
export default defineMcpTool({
  description: 'List @movk/maplibre capabilities (components, composables, utils) organized by category. Filter by category or a search term; with no params returns the full catalog grouped by category. Use this first to discover what the library offers.',
  annotations: {
    readOnlyHint: true,
