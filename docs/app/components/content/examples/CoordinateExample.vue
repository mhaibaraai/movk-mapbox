...
import { transformPoint } from '@movk/maplibre/utils/coordinate'
...
<template>
  <div class="h-115 w-full overflow-hidden rounded-(--ui-radius) border border-default">
    <MaplibreMap :options="{ style: 'https://tiles.openfreemap.org/styles/positron', center: wgs84, zoom: 15 }">
      <MaplibreTiandituLayer layer="vec" annotation />
      <MaplibreMarker :lnglat="wgs84">
        <div class="rounded bg-success px-2 py-0.5 text-xs font-medium text-inverted">
          WGS84：对齐天地图
        </div>
      </MaplibreMarker>
      <MaplibreMarker :lnglat="gcj02">
