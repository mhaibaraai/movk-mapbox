...
seo:
  ...
  description: createTianditu wraps Tianditu place search, geocoding, administrative divisions and route planning behind one client; bind tk once, all results in WGS84.
links:
  - label: Tianditu place search docs
    icon: i-lucide-external-link
    to: https://lbs.tianditu.gov.cn/server/search2.html
    target: _blank
  - label: Tianditu administrative division docs
    icon: i-lucide-external-link
    to: https://lbs.tianditu.gov.cn/server/administrative2.html
    target: _blank
  - label: Tianditu driving route docs
    icon: i-lucide-external-link
    to: https://lbs.tianditu.gov.cn/server/drive.html
    target: _blank
---
