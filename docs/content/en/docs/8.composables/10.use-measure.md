...
::note
When used outside a `<MaplibreMap>` subtree, specify the target map via `options.mapId`. Readout formatting reuses [formatDistance / formatArea](/docs/utils/measure).
::
