...
- [**`/llms.txt`**](https://maplibre.mhaibaraai.cn/llms.txt): A structured overview of all content with documentation links (~5K tokens)
- [**`/llms-full.txt`**](https://maplibre.mhaibaraai.cn/llms-full.txt): The complete documentation including implementation details, examples, type definitions, and best practices (large)
...
- "Use the Movk MapLibre documentation at `https://maplibre.mhaibaraai.cn/llms.txt`"
- "Follow the full guide at `https://maplibre.mhaibaraai.cn/llms-full.txt`"
